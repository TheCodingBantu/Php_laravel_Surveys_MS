                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <div class="small fw-bold text-primary mb-1">Total Orders ({{$branch->branch_name}})</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card border-start-lg border-start-secondary h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <div class="small fw-bold text-secondary mb-1">Total Surveys Sent</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card border-start-lg border-start-success h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <div class="small fw-bold text-success mb-1">Total Surveys Received</div>
        ...
        <div class="row mb-4">
            <div class="col-lg-8">
                ...
                <div class="card h-100 ">
                    <div class="card-header text-success">Average Rating distribution ({{$branch->branch_name}})</div>
                    <div class="card-body d-flex flex-column justify-content-center">
                        <div class="chart-bar">
                            ...
                            </div><canvas id="branchRatingChart" width="566" height="480"
